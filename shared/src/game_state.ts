...
export function initGameState(player_id_1 : PlayerId, player_id_2 : PlayerId, gameId : string) : GameState{
    ...
    //Init a game
    let game : GameState = {player1Id : player_id_1, player2Id : player_id_2, player1exp : [1], player2exp : [1], currentTurn : (Math.floor(Math.random() * 2) + 1 as 1 | 2), availableCards : cards, id : gameId};
